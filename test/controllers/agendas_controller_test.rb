...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { direccion: @agenda.direccion, nombre: @agenda.nombre, numerotelefono: @agenda.numerotelefono }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { direccion: @agenda.direccion, nombre: @agenda.nombre, numerotelefono: @agenda.numerotelefono }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
